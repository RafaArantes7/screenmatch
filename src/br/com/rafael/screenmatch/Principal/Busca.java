...
import br.com.rafael.screenmatch.modelos.TituloOmdb;
...
public class Busca {
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        while (!busca.equalsIgnoreCase("sair")) {
            ...
            String endereco = "http://www.omdbapi.com/?t=" + busca.replace(" ", "+") + "&apikey=4680b6df";
            try {
                ...
                System.out.println("Algum erro no argumento na busca, verifique o nome");
